PROGRAM nwd
  ...
  DO ji = 192, 192
    DO jj = 143, 143
      ...
      PRINT*,' precipout0 = ',precipout0(ji,jj,1)
      PRINT*,' precipout001 = ',precipout001(ji,jj,1)
      PRINT*,' precipout01 = ',precipout01(ji,jj,1)
      PRINT*,' precipout05 = ',precipout05(ji,jj,1)
      PRINT*,' precipout1 = ',precipout1(ji,jj,1)

      PRINT*,' sum precipin = ',SUM(precipin(ji,jj,:),mask=precipin(ji,jj,:)>-1.)

      PRINT*,' all precipin = ',precipin(ji,jj,:)
      ...
      IF ( precipout001(ji,jj,1) > 0. ) THEN
        intens001(ji,jj,1)= SUM(precipin(ji,jj,:)) / precipout001(ji,jj,1)
      ELSE
        intens001(ji,jj,1)  = 0.
      ENDIF

      IF ( precipout01(ji,jj,1) > 0. ) THEN
        intens01(ji,jj,1) = SUM(precipin(ji,jj,:)) / precipout01(ji,jj,1)
      ELSE
        intens01(ji,jj,1)  = 0.
      ENDIF

      IF ( precipout05(ji,jj,1) > 0. ) THEN
        intens05(ji,jj,1) = SUM(precipin(ji,jj,:)) / precipout05(ji,jj,1)
      ELSE
        intens05(ji,jj,1)  = 0.
      ENDIF

      IF ( precipout1(ji,jj,1) > 0. ) THEN
        intens1(ji,jj,1)  = SUM(precipin(ji,jj,:)) / precipout1(ji,jj,1)
      ELSE
        intens1(ji,jj,1)  = 0.
      ENDIF
