PROGRAM add_ens
  ...
  narg=iargc()
  IF ( narg == 0 ) THEN
     PRINT *,' USAGE : add_ens file var1 var2 '
     STOP
  ENDIF
  ...
  istatus=NF90_DEF_DIM(ncid,'ensemble',1,id_z); ; PRINT *,'Def dim :',NF90_STRERROR(istatus)

  varzname1=TRIM(varname1)//'_ensemble'
  varzname2=TRIM(varname2)//'_ensemble'
  ...
  istatus=NF90_COPY_ATT(ncid,idvar1,'long_name',ncid,idvarz1)
  istatus=NF90_COPY_ATT(ncid,idvar1,'units',ncid,idvarz1)
  istatus=NF90_COPY_ATT(ncid,idvar1,'online_operation',ncid,idvarz1)
  istatus=NF90_COPY_ATT(ncid,idvar1,'interval_operation',ncid,idvarz1)
  istatus=NF90_COPY_ATT(ncid,idvar1,'interval_write',ncid,idvarz1)
  istatus=NF90_COPY_ATT(ncid,idvar1,'_FillValue',ncid,idvarz1)
  istatus=NF90_COPY_ATT(ncid,idvar1,'missing_value',ncid,idvarz1)
  istatus=NF90_COPY_ATT(ncid,idvar1,'coordinates',ncid,idvarz1)

  istatus=NF90_COPY_ATT(ncid,idvar2,'long_name',ncid,idvarz2)
  istatus=NF90_COPY_ATT(ncid,idvar2,'units',ncid,idvarz2)
  istatus=NF90_COPY_ATT(ncid,idvar2,'online_operation',ncid,idvarz2)
  istatus=NF90_COPY_ATT(ncid,idvar2,'interval_operation',ncid,idvarz2)
  istatus=NF90_COPY_ATT(ncid,idvar2,'interval_write',ncid,idvarz2)
  istatus=NF90_COPY_ATT(ncid,idvar2,'_FillValue',ncid,idvarz2)
  istatus=NF90_COPY_ATT(ncid,idvar2,'missing_value',ncid,idvarz2)
  istatus=NF90_COPY_ATT(ncid,idvar2,'coordinates',ncid,idvarz2)
